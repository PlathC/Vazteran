#ifndef VZT_SYNCHRONIZATION_HPP
#define VZT_SYNCHRONIZATION_HPP
...
namespace vzt
{
    enum class PipelineStage
    {
        ...
        TesselationControlShader      = VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT,
