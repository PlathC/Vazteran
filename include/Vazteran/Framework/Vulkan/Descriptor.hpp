#ifndef VAZTERAN_FRAMEWORK_VULKAN_DESCRIPTOR_HPP
#define VAZTERAN_FRAMEWORK_VULKAN_DESCRIPTOR_HPP
...
namespace vzt
{
	...
	class DescriptorPool
	{
	  public:
		...
		uint32_t Remaining() const { return m_maxSetNb - m_descriptors.size(); }
...
#endif // VAZTERAN_FRAMEWORK_VULKAN_DESCRIPTOR_HPP
